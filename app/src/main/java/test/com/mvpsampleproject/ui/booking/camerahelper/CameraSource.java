...
import com.tcs.pickupapp.ui.booking.BookingActivity;
...
public class CameraSource {
    ...
    public CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            ...
            try {
                ...
                Toast.makeText(mContext, "Fail to connect to camera", Toast.LENGTH_SHORT).show();
    ...
    private Camera createCamera() {
        ...
        for (Camera.Size size : parameters.getSupportedPictureSizes()) {
            if (size.width == global.PREFERED_PREVIEW_WIDTH && size.height == global.PREFERED_PREVIEW_HEIGHT) {
                parameters.setPreviewSize(size.width, size.height);
                parameters.setPictureSize(size.width, size.height);
                sizePair = selectSizePair(camera, mRequestedPreviewWidth, mRequestedPreviewHeight);
                break;
            } else {
