...
/**
 * Created by os.developer2 on 4/11/2017.
 */
...
public class RuntimePermissionActivity extends AppCompatActivity {
    ...
    public static void startActivity(@NonNull final Fragment fragment,
        ...
        final Intent intent = new Intent(context, RuntimePermissionActivity.class);
        ...
        intent.putStringArrayListExtra(REQUESTED_PERMISSION, new ArrayList<String>(requestedPermissions));
    ...
    public static void startActivity(@NonNull final FragmentActivity activity,
                                     final int requestCode,
                                     @NonNull final String requestedPermission,
                                     final String... permissions) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!permissionRationaleNeeded.isEmpty()) {
            String message = "Permissions are needed to use the app";
